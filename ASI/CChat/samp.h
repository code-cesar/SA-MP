...
#define SAMP_DIALOG_INFO_OFFSET_0_3_7		0x21A0B8
#define HOOK_CLOSEDIALOG_0_3_7				0x6C04D
...
struct stRemotePlayer
{
	...
	{
		if (this->iNameLen <= 0xF)
			return this->szPlayerName;
		return this->pszPlayerName;
	}
};
